...
import 'package:stranded/util/duplicate_list.dart';
import 'package:quiver/core.dart';

class FightSituation extends Situation {
  final List<Actor> playerTeam;
  final List<Actor> enemyTeam;

  FightSituation(this.playerTeam, this.enemyTeam, {int time: 0}) : super(time);

  @override
  Situation clone() => new FightSituation(
      duplicateList(playerTeam, duplicateActor),
      duplicateList(enemyTeam, duplicateActor),
      time: time);
